...
##DERIVED VARIABLES to recode:
{
  ...
  #################
  {
    ...
    temp <- summary(factor(ccc19x$der_ordinal_v3a[ccc19x$redcap_repeat_instrument == '']))
    ...
    temp <- summary(ccc19x$der_ordinal_v4[ccc19x$redcap_repeat_instrument == ''])
